...
<head lang="en">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('front_assets/css/base.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front_assets/css/blocks.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front_assets/css/layouts.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front_assets/css/modules.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front_assets/css/widgets-styles.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('front_assets/css/ion.rangeSlider.css')}}">


	<!--Plugins styles-->

	<link rel="stylesheet" type="text/css" href="{{asset('front_assets/css/jquery.mCustomScrollbar.css')}}">
	...
	<div class="container">
		<div class="top-bar-contact">
			<div class="contact-item">
				<img loading="lazy" src="front_assets/img/united-states-of-america.png" class="flags" alt="flag">
				<select>
		...
		<div class="login-block">
			<img loading="lazy" src="front_assets/img/signin_dark.png" class="sign-in">
		...
		<div class="follow_us">
			...
			<div class="socials">
				...
				<a href="#" class="social__item">
					<img loading="lazy" src="front_assets/svg/circle-facebook.svg" alt="facebook">
				</a>

				<a href="#" class="social__item">
					<img loading="lazy" src="front_assets/svg/twitter.svg" alt="twitter">
				</a>

				<a href="#" class="social__item">
					<img loading="lazy" src="front_assets/svg/google.svg" alt="google">
				</a>

				<a href="#" class="social__item">
					<img loading="lazy" src="front_assets/svg/youtube.svg" alt="youtube">
				</a>
	...
	<div class="container">
		...
		<div class="header-content-wrapper">
			...
			<div class="logo">
				...
				<img loading="lazy" src="front_assets/img/logo-eye.png" alt="Seosight">
				<div class="logo-text">
									...
									<ul>
										<li>
											<div class="google-logo">
												<img loading="lazy" src="front_assets/img/google-logo.png" alt="logo">
											</div>
	...
	<div class="popup right-menu">
		...
		<div class="widget contacts">
			...
			<div class="contacts-item">
				<img loading="lazy" src="front_assets/img/contact4.png" alt="phone">
				<div class="content">
			...
			<div class="contacts-item">
				<img loading="lazy" src="front_assets/img/contact5.png" alt="phone">
				<div class="content">
			...
			<div class="contacts-item">
				<img loading="lazy" src="front_assets/img/contact6.png" alt="phone">
				<div class="content">
	...
	<div class="container info-boxes pt100 pb100">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					<div class="info-box-image">
						<img loading="lazy" src="front_assets/img/info-box1.png" alt="image">
					</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					<div class="info-box-image">
						<img loading="lazy" src="front_assets/img/info-box2.png" alt="image">
					</div>
					<div class="info-box-content">
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					<div class="info-box-image">
						<img loading="lazy" src="front_assets/img/info-box3.png" alt="image">
					</div>
					<div class="info-box-content">
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					<div class="info-box-image">
						<img loading="lazy" src="front_assets/img/info-box4.png" alt="image">
					</div>
					<div class="info-box-content">
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					<div class="info-box-image">
						<img loading="lazy" src="front_assets/img/info-box5.png" alt="image">
					</div>
					<div class="info-box-content">
			...
			<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				<div class="info-box--standard" data-mh="info-boxes">
					<div class="info-box-image">
						<img loading="lazy" src="front_assets/img/info-box6.png" alt="image">
					</div>
					<div class="info-box-content">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="seo-score scrollme">
						...
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-xs-12 col-sm-12">
							<div class="seo-score-content align-center">
								...
								<div class="seo-score-form">
									...
									<form class="seo-score-form input-inline crumina-submit" data-nonce="crumina-submit-form-nonce" data-type="standard" action="https://html.crumina.net/html-seosight/modules/forms/submit.php">
				...
				<div class="images">
					<img loading="lazy" src="front_assets/img/seoscore1.png" alt="image">
					<img loading="lazy" src="front_assets/img/seoscore2.png" alt="image">
					<img loading="lazy" src="front_assets/img/seoscore3.png" alt="image">
				</div>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							<div class="offers-thumb">
								<img loading="lazy" src="front_assets/img/offers1.png" alt="offers">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="video theme-module">
						<div class="video-thumb">
							...
							<a href="https://www.youtube.com/watch?v=0O2aH4XLbto" class="video-control js-popup-iframe">
								<img loading="lazy" src="front_assets/svg/video-control.svg" alt="go">
							</a>
						</div>
					</div>
				</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="background-mountains medium-padding120 scrollme">
				...
				<div class="images">
					<img loading="lazy" src="front_assets/img/mountain1.png" alt="mountain">
					<img loading="lazy" src="front_assets/img/mountain2.png" alt="mountain">
				</div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								<div class="info-box-image">
									<img loading="lazy" src="front_assets/img/info-box7.png" alt="image">
								</div>
								<div class="info-box-content">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								<div class="info-box-image">
									<img loading="lazy" src="front_assets/img/info-box8.png" alt="image">
								</div>
								<div class="info-box-content">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								<div class="info-box-image">
									<img loading="lazy" src="front_assets/img/info-box9.png" alt="image">
								</div>
								<div class="info-box-content">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							<div class="info-box--standard-centered">
								<div class="info-box-image">
									<img loading="lazy" src="front_assets/img/info-box10.png" alt="image">
								</div>
								<div class="info-box-content">
					...
					<div class="row">
						<div class="case-item-wrap">
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
								<div class="case-item">
									<div class="case-item__thumb">
										<img loading="lazy" src="front_assets/img/case1.jpg" alt="our case">
									</div>
							...
							<div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
								<div class="case-item">
									<div class="case-item__thumb">
										<img loading="lazy" src="front_assets/img/case2.jpg" alt="our case">
									</div>
							...
							<div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
								<div class="case-item">
									<div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
										<img loading="lazy" src="front_assets/img/case3.jpg" alt="our case">
									</div>
		...
		<div class="row">
			<div class="testimonial-slider scrollme">
						...
						<div class="col-lg-7 col-lg-offset-1 col-md-8 col-sm-12 col-xs-12">
							...
							<div class="testimonial-item">
									...
									<div class="swiper-wrapper">
										<div class="testimonial-slider-item swiper-slide">
											...
											<div class="avatar" data-swiper-parallax="-50">
												<img loading="lazy" src="front_assets/img/avatar.png" alt="avatar">
											</div>
										</div>
										<div class="testimonial-slider-item swiper-slide">
											<div class="testimonial-content">
								...
								<div class="testimonial__thumb-img">
									<img loading="lazy" src="front_assets/img/testimonial1.png" alt="image">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="testimonial-img">
					<img loading="lazy" src="front_assets/img/testimonial2.png" alt="image">
				</div>
			</div>
		</div>
	</div>
					...
					<div class="row">
						<div class="pricing-tables-wrap">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="pricing-tables-item">
									<div class="pricing-tables-icon">
										<img loading="lazy" src="front_assets/img/pricing1.png" alt="personal">
									</div>
									...
									<img loading="lazy" src="front_assets/img/pricing-dots.png" class="dots" alt="dots">
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<div class="pricing-tables-item">
									<div class="pricing-tables-icon">
										<img loading="lazy" src="front_assets/img/pricing2.png" alt="personal">
									</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<div class="pricing-tables-item">
									<div class="pricing-tables-icon">
										<img loading="lazy" src="front_assets/img/pricing3.png" alt="personal">
									</div>
					...
					<div class="swiper-wrapper">
							...
							<article class="hentry post">
								...
								<div class="post__author author vcard">
									<div class="post-avatar">
										<img loading="lazy" src="front_assets/img/post-author1.png" alt="author">
									</div>
						...
						<div class="swiper-slide">
							<article class="hentry post">
								...
								<div class="post__author author vcard">
									<div class="post-avatar">
										<img loading="lazy" src="front_assets/img/post-author2.png" alt="author">
									</div>
									<span class="post__author-name fn"> Posted by <a href="#" class="post__author-link">Admin</a></span>
								</div>
						...
						<div class="swiper-slide">
							<article class="hentry post">
								...
								<div class="post__author author vcard">
									<div class="post-avatar">
										<img loading="lazy" src="front_assets/img/post-author3.png" alt="author">
									</div>
									<span class="post__author-name fn"> Posted by <a href="#" class="post__author-link">Admin</a></span>
								</div>
						...
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide client-item">
								<a href="09_our_clients.html" class="client-image">
									<img loading="lazy" src="front_assets/img/client1-hover.png" alt="logo" class="hover">
								</a>
							</div>

							<div class="swiper-slide client-item">
								<a href="09_our_clients.html" class="client-image">
									<img loading="lazy" src="front_assets/img/client2-hover.png" alt="logo" class="hover">
								</a>
							</div>

							<div class="swiper-slide client-item">
								<a href="09_our_clients.html" class="client-image">
									<img loading="lazy" src="front_assets/img/client3-hover.png" alt="logo" class="hover">
								</a>
							</div>

							<div class="swiper-slide client-item">
								<a href="09_our_clients.html" class="client-image">
									<img loading="lazy" src="front_assets/img/client4-hover.png" alt="logo" class="hover">
								</a>
							</div>
				...
				<div class="row">
					...
					<div class="subscribe scrollme">
						...
						<div class="images-block">
							<img loading="lazy" src="front_assets/img/subscr-gear.png" alt="gear" class="gear">
							<img loading="lazy" src="front_assets/img/subscr1.png" alt="mail" class="mail">
							<img loading="lazy" src="front_assets/img/subscr-mailopen.png" alt="mail" class="mail-2">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="info">
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					...
					<div class="socials">
						...
						<a href="#" class="social__item">
							<img loading="lazy" src="front_assets/svg/rss.svg" alt="rss">
						</a>
					</div>
				</div>
...
<script src="{{asset('front_assets/js/js-plugins/crum-mega-menu.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/swiper.jquery.min.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/waypoints.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery.drawsvg.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery-countTo.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery.mousewheel.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery.mCustomScrollbar.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/imagesLoaded.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery.magnific-popup.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery.matchHeight.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/segment.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/bootstrap.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery-circle-progress.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/Headroom.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/smooth-scroll.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/jquery.nice-select.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/fastClick.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/form-actions.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/velocity.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/time-line.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/ScrollMagic.min.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/animation.velocity.min.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/ajax-pagination.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/donut-chart.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/isotope.pkgd.min.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/photo-gallery.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/ion.rangeSlider.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/leaflet.js')}}"></script>
<script src="{{asset('front_assets/js/js-plugins/MarkerClusterGroup.js')}}"></script>

<script src="{{asset('front_assets/js/main.js')}}"></script>

<!-- jQuery-scripts for Modules (Send Message) -->
<script src="{{asset('front_assets/modules/forms/src/js/jquery.validate.min.js')}}"></script>
<script src="{{asset('front_assets/modules/forms/src/js/sweetalert2.all.js')}}"></script>
<script src="{{asset('front_assets/modules/forms/src/js/scripts.js')}}"></script>
<!-- /jQuery-scripts for Modules (Send Message) -->
...
<!-- Mirrored from html.crumina.net/html-seosight/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 May 2024 12:10:33 GMT -->
</html>
